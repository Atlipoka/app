...
1.  Разворачиваем виртуалку с помощью ``jenkins-master.tf`` и сетапим на нее все необходимое с помощью ансибловых сприптов, которые нахоятся в папке ``setup-vm/``.
